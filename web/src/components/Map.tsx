...
const LEGEND_ITEMS = [
  ...
  { cls: "caution",   color: ROUTE_CLASS_COLORS.caution,   label: "Bike lane on a busy street — use caution", dashed: false },
        ...
        paint: {
          ...
          "line-width": [
            ...
            10, ["match", ["get", "rclass"],
              ...
              ["lane", "buffered", "caution"], 1.2,
              1.0,
            ],
            16, ["match", ["get", "rclass"],
              ["protected", "greenway", "path"], 5,
              ["lane", "buffered", "caution"], 3.5,
              2.5,
            ],
          ] as any,
          "line-opacity": 0.85,
